...
Session generation changes do not change either version axis. A host may advertise newer wire versions in its capabilities, but the current beta-development implementation supports only `0.1.0-draft.2`.
