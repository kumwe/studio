...
| Content model      | The canonical Studio field-and-constraint artifact to which a Blueprint may bind; hosts may map it from a Kumwe content type, business definition, or equivalent domain model. |
