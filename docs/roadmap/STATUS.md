...
| Current authoritative activity    | Treat the completed Gate A TypeScript corpus increment as implemented but unaccepted, merge and publish the reviewed whole-family alpha plan after the npm-token rotation, finish each target-only specialized proof producer, ground App [PR #114](https://github.com/kumwe/app/pull/114) against that exact family, complete `authoring-web`, configure the externally pinned reviewer authority, and assemble independently signed evidence |
| Repository verification baseline  | `a6f8bde93046a5b5560a919cff5975a32036a5aa`: PR #40's complete generated TypeScript protocol models and corpus verification are merged with PR #37's governed release controls; `gate-a/09-typescript-corpus` implementation is complete while its specialized portability evidence remains target-only                                                                                                                                         |
...
| ------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `M1-04` | evidence-review | Stable criterion registry; exact 60-class Gate A/B proof registry; closed producer/role/run, manual-step, external-subject, artifact-closure, repository-structural plus protected-release SSH-review bindings; current-main RC controller; generator refuses partial claims                                                | Activate real reviewer public keys plus matching repository/protected registry digests; land per-role validators and specialized lifecycle/integration/portability/release/Gate B producers; authenticate grounded App proof; then reproduce and retain evidence |
...
2. Land closed semantic schemas, deterministic producers, and hostile substitution tests for every currently
   target-only specialized Gate A role: contribution lifecycle, reference-host and media/rich-text integration,
   TypeScript portability, reproducible family/SBOM, and staged-registry proof. Keep all Gate B bindings target
   until their own per-role validators and producers exist; arbitrary bytes under a plausible label are not
   evidence.
