...
- Complete the beta.2 host-neutral authoring runtime: configuration-first standalone and hosted deployment,
  local import/download fallback, contextual extension targets, the exact seven-operation AJAX adapter, and
  host-minted successor-context advancement after accepted saves. Deployment documents now require `kind`,
  `mount`, and a release identity copied from the verified browser-assets manifest.
...
- [#34](https://github.com/kumwe/studio/pull/34) [`3697049`](https://github.com/kumwe/studio/commit/36970498f532288aa7ff747f7eddcf47432abdb3) Thanks [@Llewellynvdm](https://github.com/Llewellynvdm)! - Expose optional, host-neutral resource search from the composed Studio session with bounded canonical
  queries, detached matched pages, precise optional-port diagnostics, and stale-generation invalidation.
...
- [#34](https://github.com/kumwe/studio/pull/34) [`11943aa`](https://github.com/kumwe/studio/commit/11943aac68d2c59b141a38f2e1bf323db38885b1) Thanks [@Llewellynvdm](https://github.com/Llewellynvdm)! - Validate every responsive viewport's effective block properties against the exact registered
  `propertySchema`, with diagnostics anchored to the stored override that prevents publication.
- Updated dependencies [[`d82f974`](https://github.com/kumwe/studio/commit/d82f97469fc216d85b9986d17cd48f423a6fae1c), [`fbdda1e`](https://github.com/kumwe/studio/commit/fbdda1e1ece32680be6b93b993d7a8dedee98a26), [`2a1d3e1`](https://github.com/kumwe/studio/commit/2a1d3e1b6d88d771beca97744294ed77d237b66e), [`6ca9916`](https://github.com/kumwe/studio/commit/6ca9916c06390834a4a7aa62e6f0587f29d4926e), [`1d2c89e`](https://github.com/kumwe/studio/commit/1d2c89eb580df1b2924681148f7688c376a7a3a5), [`884bffc`](https://github.com/kumwe/studio/commit/884bffc53b27c78955f77e2e77cc3f7d6b6c778e), [`dc3119c`](https://github.com/kumwe/studio/commit/dc3119c678f3e944de913701adcc4b754b01f4e3), [`2ef0ce2`](https://github.com/kumwe/studio/commit/2ef0ce27759782a67731fcb8c6dbd1636a1eaccb), [`dcad5c8`](https://github.com/kumwe/studio/commit/dcad5c83a8b1756323e2b6890b36d68399554967), [`5786796`](https://github.com/kumwe/studio/commit/57867967fe443173eeeda209df30a796bc9c311d), [`bda990a`](https://github.com/kumwe/studio/commit/bda990abbccaae2b1d0386279b9ffbd8d561da8f), [`1d2c89e`](https://github.com/kumwe/studio/commit/1d2c89eb580df1b2924681148f7688c376a7a3a5)]:
