...
- Ship deterministic minified JavaScript in the coordinated beta.2 package layer while preserving the canonical
  Editor.js-backed JSON and strict-CSP sink-free authoring surfaces.
...
- [#34](https://github.com/kumwe/studio/pull/34) [`78ea935`](https://github.com/kumwe/studio/commit/78ea93538f8cb2a9ac5363aca6fe9febdf2fc668) Thanks [@Llewellynvdm](https://github.com/Llewellynvdm)! - Replace the editor-specific rich-text surface with a Studio-owned Editor.js adapter that exposes
  only canonical profile-valid values, plus bounded Markdown and safe HTML import/export.
